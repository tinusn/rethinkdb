...
*  syntax: table.orderBy([key1...], {index: index_name}) → selection<stream>
	...
	interface rBinary extends rSlice<rBinary> {

	}

	interface rdbArray extends Sequence, rStreamArray<rdbArray>, rNext, rEach, rToArray, rFilter<rdbArray>, rInnerJoin<rdbArray>, rSlice<rdbArray>, rUninion<rdbArray>, rSample<rdbArray>, rPluck<rdbArray>, rWithout<rdbArray>, rMerge<rdbArray>, rHasFields<rdbArray> {
		/**
